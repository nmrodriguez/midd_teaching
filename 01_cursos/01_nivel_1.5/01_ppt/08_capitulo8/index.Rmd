...
- Vamos a escribir de una tradición o costumbre en nuestras familias. 
...
Debes preparar un cuento, un relato o una anécdota  de 2 minutos.
Debes usar un Power Point de 6 diapositivas de imágenes (pero sin palabras) que están con un límite de 20 segundos cada uno (total 2 minutos). (Transitions-> No Transition-> Options - en la última línea de esta caja de diálogo hay que indicar que las transiciones se hace “automáticamente después de 20 segundos”) o puedes usar la plantilla con las transiciones automáticas.
El cuento/relato puede ser imaginario o real y debe estar estructurado de la siguiente manera:

- anunciar el cuento (les voy a contar un cuento sobre XXX) (optativo)

- situación inicial (descripción de personajes y lugares, suele contarse en imperfecto)

- nudo o acción (de repente, un día, suele contarse en pretérito)

- intriga o reacción

- desenlace

- situación final (tiene cierta simetría con la situación inicial)

- moraleja (optativa)

NO debes escribir NUNCA este texto. Solamente te debes basar en una ficha con la estructura básica de tu cuento y algunas palabras sueltas.
No uses el mismo cuento para el ejercicio en la clase de escritura, por favor.
